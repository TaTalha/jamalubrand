...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mJAMALU BRAND\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------JAMALU BRAND----------------»")
        love("\033[1;95mB4Baloch 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mJAMALU BRAND\033[1;96m--------------»")
        time.sleep(0.3)
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░JAMALU BRAND╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░B4_JAMALI_M4_BRAND╔╝
...
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█JAMALU█╗░░M4║██BRAND██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
\033[1;47m\033[1;31m      PAKISTANI HACKER       \033[1;0m
\033[1;96m«-----------------\033[1;91mJAMALU BRAND\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  JAMALU
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  HACKER
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   LOVE
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  JAMALU░░░░░░BRAND░░PAKISTANI░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  JAMALU░░░░░BRAND██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░***********░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░JAMALU CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  HI, I AM JAMALU BRAND A ETICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  JAMALU BRAND WHATSAPP = *********** | lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL B4 JAMALU M4 MASTER | lolcat -a -F 0.1')
    ...
    os.system('echo ----------------JAMALU BRAND-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  JAMALU BRAND lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  BRAND HACKER lolcat --animate')
    ...
    os.system('echo -----------------JAMALU HACKER----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo [W]  B4 JAMALU M4 MASTER WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     JAMALU ")
                ...
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     JAMALI ")
                love("\033[1;93mTool Password  :\033[1;95m     BRAND ")
